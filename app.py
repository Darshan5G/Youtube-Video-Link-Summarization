...
class YouTubeSummaryGenerator:
    ...
    def select_auto_generated_language(self, url):
        """
        Select the auto-generated language for the transcript.
        """
        try:
            languages = self.get_transcript_languages(url)
    ...
    def generate_summary(self, url):
        ...
        """
        try:
            select_lang = self.select_auto_generated_language(url)[:2]
